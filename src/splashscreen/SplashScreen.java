...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbStatus.setFont(new java.awt.Font("Comfortaa SemiBold", 0, 14)); // NOI18N
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    doTask("Inicializando Servicios ...", 20);
                    doTask("Cargando Componentes ...", 30);
                    doTask("Cargando Productos ...", 40);
                    doTask("Inicializando Paneles ...", 50);
                    doTask("60% Completado ...", 60);
                    doTask("70% Completado...", 70);
                    doTask("80% Completado ...", 80);
                    doTask("90% Completado ...", 90);
                    doTask("Inicializando Sistema ...", 100);
                    doTask("Carga Completa ...", 100);
                    dispose();
